...
function initializeAllSettings() {
    ...
    createSetting('PrestigeSkipMode', 'Prestige Skip Mode', 'If there are more than 2 Unbought Prestiges (besides Shield), ie: sitting in your upgrade window but you cant afford them, AutoMaps will not enter Prestige Mode, or will exit from it. The amount of unboughts can be configured with this variable MODULES["automaps"].SkipNumUnboughtPrestiges = 2;', 'boolean', false, null, "Maps");
