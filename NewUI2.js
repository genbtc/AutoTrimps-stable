...
createSetting('RunBionicBeforeSpire', 'Run Bionic Before Spire', 'CAUTION:  Runs Bionic Wonderlands I through VI and then repeatedly farms VI(level 200) before attempting Spire, for the purpose of farming. The \"minutes before spire\" timer runs concurrently to this, and will exit without doing anything if not set. Then attempts the spire. You can un-toggle it as desired. WARNING: DO NOT USE WITH HE/HR PORTAL (it will portal due to He/Hr suffers).' , 'boolean', null, null, 'genBTC');
