...
createSetting('GeneticistTimer', 'Geneticist Timer', 'Manages the breed timer by hiring/firing Geneticists for the purpose of setting the ideal anticpation stacks. Disable with -1 to disable the Hiring/Firing of geneticists.  Also self-kills (autohomicide) when your anti-stacks arent maxed out (conservatively). <br><b>Info:</b> Only buys when you are in D or S stance. Potency and Nursery buying behavior is adjusted dynamically (and disabling no longer disables potency). The Automatic Genetecist Hiring Process can best be summarized by: Buy/Wait/Die,Repeat. (if you do not die, no action is taken).<p><B>Controlled automatically (locked) when Auto Breed Timer is on</B>.', 'value', '30',null,"Core");
...
createSetting('RunBionicBeforeSpire', 'Run Bionic Before Spire', 'CAUTION: ONE TIME USE. Runs Bionic Wonderlands I through VI and then repeatedly farms VI(level 200) before attempting Spire, for the purpose of farming. WARNING: The point at which it stops farming has yet to be fully decided upon or set in stone, so it currently runs Bionic VI until it runs out of new prestige item rewards, then runs Bionic VII until it runs out of prestige items from that one, and then attempts the spire. This amounts to somewhere around 144 minutes. If you are too weak, it will take even longer and maybe get stuck. You can un-toggle it as desired. WARNING: DO NOT USE WITH HE/HR PORTAL (it will portal).He/Hr suffers, Not meant to be used every time.' , 'boolean', null, null, 'genBTC');
