...
createSetting('AutoHeirlooms2', 'Auto Heirlooms2', 'genBTCs fixed version of AutoHeirlooms, aptly named AutoHeirlooms2. While this is active, it will disable the old AutoHeirlooms. Turning this on will immediately re-sort your heirlooms according to the new algorithm, and turning it off again, DOES revert to the original AutoHeirlooms algorithm even though it will not have a visible result on your heirlooms. (This was part of the problem with the old one.) ', 'boolean', null, null, 'genbtcadvancedSettings');
